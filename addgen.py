...
def createAdds(res):
	...
	for add in res:
		...
		addText = addText.replace(':kilometri', add.kilometri)
		addText = addText.replace(':godina', add.godina)
		addText = addText.replace(':motor', add.motor)
		addText = addText.replace(':garaziran', add.garaziran)
		...
		addText = addText.replace(':datum', add.datum_objave)
